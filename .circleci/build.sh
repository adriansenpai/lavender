...
git clone --depth=1 https://github.com/adriansenpai/lavender -b Keido-Kernel kernel
cd kernel
...
export KBUILD_BUILD_USER="adriansenpai"
# sticker plox
function sticker() {
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 Keido-Kernel-testbuild.zip *
    cd .. 
}
sticker
sendinfo
